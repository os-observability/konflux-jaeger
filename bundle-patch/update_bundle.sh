...
export JAEGER_COLLECTOR_IMAGE_PULLSPEC="quay.io/redhat-user-workloads/rhosdt-tenant/jaeger/jaeger-collector@sha256:5fba0e1250b770199604232cda79ec59923c895011331d5536c307e2fea39156"
...
# Separate due to merge conflicts
export JAEGER_QUERY_IMAGE_PULLSPEC="quay.io/redhat-user-workloads/rhosdt-tenant/jaeger/jaeger-query@sha256:4e8dcc7fb08ea39d088b99357d473b2b632b4b19851464413616d957c8548fe7"
# Separate due to merge conflicts
export JAEGER_ALL_IN_ONE_IMAGE_PULLSPEC="quay.io/redhat-user-workloads/rhosdt-tenant/jaeger/jaeger-all-in-one@sha256:af0f0f25405c0a0babd72c75da7a409bf44b7e34787323780cc0c2e652c49249"
# Separate due to merge conflicts
...
# Separate due to merge conflicts
export JAEGER_OPERATOR_IMAGE_PULLSPEC="quay.io/redhat-user-workloads/rhosdt-tenant/jaeger/jaeger-operator@sha256:6d7cdc79bb28f65c7c2a7d482cbf1cfb984430a038d68707a5aca4c7892d25d2"
# Separate due to merge conflicts
